...
export class OfferService {
  private readonly seedOffers: Offer[] = [
    ...
    {
      id: '13',
      title: 'Libreville → Port-Gentil — fret terrestre',
      likes: 33,
      date: 'lun. 22 juin 2026 | 07h00 GMT',
      price: '2 500 F CFA / kg',
      location: 'Libreville, Gabon',
      address: 'Zone logistique de Nzeng-Ayong',
      category: 'Transport routier',
      publisherName: 'Gabon Route Express',
      publisherHandle: '@GA_ROUTE_EXP',
      publisherInitials: 'GR',
      logoBg: 'linear-gradient(135deg, #334155 0%, #64748b 100%)',
      description:
        'Liaison routière quotidienne Libreville ↔ Port-Gentil. Idéal pour marchandises et colis inter-villes.',
      pricingType: 'kilo',
      departureCountry: 'Libreville',
      arrivalCountry: 'Port-Gentil',
      verified: true,
    },
    {
      id: '14',
      title: 'Port-Gentil → Libreville — retour',
      likes: 21,
      date: 'mer. 24 juin 2026 | 09h00 GMT',
      price: '2 800 F CFA / kg',
      location: 'Port-Gentil, Gabon',
      address: 'Terminal routier, Port-Gentil',
      category: 'Transport routier',
      publisherName: 'Gabon Route Express',
      publisherHandle: '@GA_ROUTE_EXP',
      publisherInitials: 'GR',
      logoBg: 'linear-gradient(135deg, #334155 0%, #64748b 100%)',
      description:
        'Retour Port-Gentil → Libreville. Départs matin et soir, suivi colis inclus.',
      pricingType: 'kilo',
      departureCountry: 'Port-Gentil',
      arrivalCountry: 'Libreville',
    },
    {
      id: '15',
      title: 'Libreville → Franceville — fret routier',
      likes: 18,
      date: 'ven. 19 juin 2026 | 06h00 GMT',
      price: '3 200 F CFA / kg',
      location: 'Libreville, Gabon',
      address: 'Gare routière Owendo',
      category: 'Transport routier',
      publisherName: 'Estuaire Transit',
      publisherHandle: '@ESTUAIRE_TRANSIT',
      publisherInitials: 'ET',
      logoBg: 'linear-gradient(135deg, #14532d 0%, #22c55e 100%)',
      description:
        'Transport Libreville ↔ Franceville via la RN1. Départs réguliers, tarif dégressif.',
      pricingType: 'kilo',
      departureCountry: 'Libreville',
      arrivalCountry: 'Franceville',
      verified: true,
    },
    {
      id: '16',
      title: 'Franceville → Libreville — colis groupé',
      likes: 14,
      date: 'sam. 20 juin 2026 | 08h00 GMT',
      price: '2 900 F CFA / kg',
      location: 'Franceville, Gabon',
      address: 'Zone commerciale Franceville',
      category: 'Transport routier',
      publisherName: 'Estuaire Transit',
      publisherHandle: '@ESTUAIRE_TRANSIT',
      publisherInitials: 'ET',
      logoBg: 'linear-gradient(135deg, #14532d 0%, #22c55e 100%)',
      description:
        'Envoi groupé Franceville → Libreville. Solution économique pour particuliers et commerçants.',
      pricingType: 'kilo',
      departureCountry: 'Franceville',
      arrivalCountry: 'Libreville',
    },
    {
      id: '17',
      title: 'Gabon → Burkina Faso — fret terrestre',
      likes: 26,
      date: 'mar. 16 juin 2026 | 10h00 GMT',
      price: '4 800 F CFA / kg',
      location: 'Libreville, Gabon',
      address: 'Aéroport Léon-Mba, Libreville',
      category: 'Transport routier',
      publisherName: 'Afrique Centrale Cargo',
      publisherHandle: '@AFRIQUE_CENTRALE',
      publisherInitials: 'AC',
      logoBg: 'linear-gradient(135deg, #78350f 0%, #f59e0b 100%)',
      description:
        'Liaison terrestre Gabon ↔ Burkina Faso. Passage par le Cameroun et le Nigeria.',
      pricingType: 'kilo',
      departureCountry: 'Gabon',
    ...
    {
      id: '18',
      title: 'Burkina Faso → Gabon — import',
      likes: 11,
      date: 'jeu. 25 juin 2026 | 11h00 GMT',
      price: '5 100 F CFA / kg',
      location: 'Ouagadougou, Burkina Faso',
      address: 'Zone logistique Ouagadougou',
      category: 'Transport routier',
      publisherName: 'Afrique Centrale Cargo',
      publisherHandle: '@AFRIQUE_CENTRALE',
      publisherInitials: 'AC',
      logoBg: 'linear-gradient(135deg, #78350f 0%, #f59e0b 100%)',
      description:
        'Réexpédition Burkina Faso → Libreville. Marchandises, textiles et produits alimentaires.',
      pricingType: 'kilo',
      departureCountry: 'Burkina Faso',
      arrivalCountry: 'Gabon',
      promotion: true,
    },
  ];
  ...
  private generateExtraOffers(startId: number, count: number): Offer[] {
    const corridors: OfferCorridor[] = [
      ...
      { departure: 'Libreville', arrival: 'Port-Gentil', location: 'Libreville, Gabon', category: 'Transport routier', pricingType: 'kilo', price: '2 500 F CFA / kg' },
      { departure: 'Port-Gentil', arrival: 'Libreville', location: 'Port-Gentil, Gabon', category: 'Transport routier', pricingType: 'kilo', price: '2 800 F CFA / kg' },
      { departure: 'Libreville', arrival: 'Franceville', location: 'Libreville, Gabon', category: 'Transport routier', pricingType: 'kilo', price: '3 200 F CFA / kg' },
      { departure: 'Franceville', arrival: 'Libreville', location: 'Franceville, Gabon', category: 'Transport routier', pricingType: 'kilo', price: '2 900 F CFA / kg' },
      { departure: 'Gabon', arrival: 'Burkina Faso', location: 'Libreville, Gabon', category: 'Transport routier', pricingType: 'kilo', price: '4 800 F CFA / kg' },
      { departure: 'Burkina Faso', arrival: 'Gabon', location: 'Ouagadougou, Burkina Faso', category: 'Transport routier', pricingType: 'kilo', price: '5 100 F CFA / kg' },
    ];
